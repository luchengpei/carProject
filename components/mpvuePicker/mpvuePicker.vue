		...
		methods: {
			...
			pickerChangeMul(e) {
				if (this.deepLength == 2) {
					...
					if (changeValue[0] !== this.pickerValue[0]) {
						...
						let length = 0;
						if (pickerValueArray[changeValue[0]].children && pickerValueArray[changeValue[0]].children[changeValue[1]].children) {
							length = pickerValueArray[changeValue[0]].children[changeValue[1]].children.length;
						}
			...
			_getPickerLabelAndValue(value, mode) {
				...
				if (mode == 'selector') {
					...
					pickerLable =
						this.deepLength == 2 ?
						`${this.pickerValueMulTwoOne[value[0]].label}${this.pickerValueMulTwoTwo[value[1]] ? ' ' + this.pickerValueMulTwoTwo[value[1]].label : ''}` :
						`${this.pickerValueMulThreeOne[value[0]].label}${this.pickerValueMulThreeTwo[value[1]] ? ' ' + this.pickerValueMulThreeTwo[value[1]].label : ''}${
								this.pickerValueMulThreeThree[value[2]] ? ' ' + this.pickerValueMulThreeThree[value[2]].label : ''
						  }`;
					if (this.deepLength == 2) {
						pickerGetValue.push(this.pickerValueMulTwoOne[value[0]].value);
						pickerGetValue.push(this.pickerValueMulTwoTwo[value[1]] ? this.pickerValueMulTwoTwo[value[1]].value : '');
					} else {
						pickerGetValue.push(this.pickerValueMulThreeOne[value[0]].value);
						pickerGetValue.push(this.pickerValueMulThreeTwo[value[1]] ? this.pickerValueMulThreeTwo[value[1]].value : '');
						pickerGetValue.push(this.pickerValueMulThreeThree[value[2]] ? this.pickerValueMulThreeThree[value[2]].value : '');
					}
			...
			getDaysList(year, month, value) {
				...
				value[2] = dayLength < this.pickerValueDay.length && this.pickerValue[2] > dayLength - 1 ? dayLength - 1 : this.pickerValue[
					2];
